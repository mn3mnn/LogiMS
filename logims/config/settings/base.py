...
MIGRATION_MODULES = {"sites": "logims.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "logims.contrib.middleware.DisableCSRFForAPI",  # Exempt API paths from CSRF
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "logims.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Monem Tarek""", "abdoeladawy4@gmail.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "logims.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "logims.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "logims.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "logims.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "LogiMS API",
    "DESCRIPTION": "Documentation of API endpoints of LogiMS",
    "VERSION": "1.0.0",
